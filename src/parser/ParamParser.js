import AbstractParamParser from 'tjsdoc-runtime-common/src/parser/AbstractParamParser.js';

/**
 * Param Type Parser.
 */
class ParamParser extends AbstractParamParser
{
   /**
    * Instantiates the ParamParser.
    *
   ...
   constructor(eventbus)
   {
      ...
      /**
       * Stores the associated plugin eventbus.
       * @type {EventProxy}
       * @private
       */
...
export function onPluginLoad(ev)
{
   ...
   const paramParser = new ParamParser(eventbus);

   eventbus.on('tjsdoc:guess:params', paramParser.guessParams, paramParser);
   eventbus.on('tjsdoc:guess:return:param', paramParser.guessReturnParam, paramParser);
   eventbus.on('tjsdoc:guess:type', paramParser.guessType, paramParser);
   eventbus.on('tjsdoc:parse:param', paramParser.parseParam, paramParser);
   eventbus.on('tjsdoc:parse:param:from:value', paramParser.parseParamFromValue, paramParser);
   eventbus.on('tjsdoc:parse:param:value', paramParser.parseParamValue, paramParser);
}
